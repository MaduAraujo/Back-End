import { Text, SafeAreaView, StyleSheet, ImageBackground, TextInput, View, TouchableOpacity } from 'react-native';
...
export default function App() {
  ...
  const calcularImc = () => {
    ...
    if (isNaN(pesoNum) || isNaN(alturaNum) || alturaNum === 0) {
      setMensagem('Insira valores válidos para peso e altura.');
      setImc(0);
      return;
    }
